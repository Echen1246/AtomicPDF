...
CREATE TABLE public.profiles (
    ...
    avatar_url TEXT,
    subscription_tier VARCHAR(20) DEFAULT 'free' CHECK (subscription_tier IN ('free', 'lifetime', 'basic', 'standard', 'professional')),
...
CREATE TABLE public.subscriptions (
    ...
    tier VARCHAR(20) NOT NULL CHECK (tier IN ('lifetime', 'basic', 'standard', 'professional')),
